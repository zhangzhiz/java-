                        ...
                        <div class="ibox-content">
                            <form id="addForm" class="form-horizontal">
								...
								<#else>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" id="${column.camelName}" name="${column.camelName}" maxlength="200"></div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                    	<a href="javascript:void(0);" onclick="add${className}();" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> 保存</button></a>
